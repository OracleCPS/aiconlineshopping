...
**1.8** Do the authentication call,click  authorize

![](images/200/img096_1.png)

**1.9** Fill in your username and password for OIC, and click **Authorize**

![](images/200/img097_1.png)

**1.10** Click on  **Execute** button at the  bottom

![](images/200/img098_1.png)

**1.11** check  **response** value. 

![](images/200/img099_1.png)
