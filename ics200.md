...
**2.1.1.1** Click on **Integrations** link. You will be redirected to the Integrations Designer page where you will select the **Connections** link

![](images/200/img112.png)

![](images/200/img113.png) 

**2.1.1.2** Click on the **Create** button in the upper right
...
**2.3.1.4** If you need the URL again, you can always get back to it by clicking on the  icon as shown below to activate your integration
...
**2.4.1.1** Next `click on this endpoint url` it will take you to a new page where we will copy our endpoint URL to your clipboard.
