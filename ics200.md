...
**1.5** Open postman,Click on **Import** button

![](images/200/img110_1.png)

**1.6** From there select **Paste Raw Text**, and paste the text into the text box.Finally click on Import button below  
...
**1.9** Fill in username and password for OIC, and click **Authorize**

![](images/200/img097_2.png)

**1.10** Click on  **Execute** button at the  bottom to test your service
