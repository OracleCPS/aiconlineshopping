...
- **RECOMMENDED:**
    - It is recommended that you have completed [Lab 100](/ics100.md)
...
**200.5.4:** Click on the **Body** tab, select the **raw** radio button and **JSON(application/json)** is selected from the dropdown.
...
> In the next lab, we are going to take a sample integration flow and add additional components to finish the flow