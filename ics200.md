...
**2.1** Click on the **Connection** section from designer page as shown below 
...
**1.8** Do the authentication call,click on authorize

![](images/200/img096.png)

**1.9** Fill in your username and password for OIC, and click **Authorize**

![](images/200/img097.png)

**1.10** Click on  **Execute** button at bottom

![](images/200/img098.png)

**1.11** check  **response** value. 

![](images/200/img099.png)
