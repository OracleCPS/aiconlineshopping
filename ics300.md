...
**1.4** A new page comes up.Provide the integration name as per your choice ,description if you wish to and Click **Clone** button as shown
...
**1.8** A new branch will be created as shown below 
...
**1.17**Update the response mapper with below mentioned fields.Click on validate to finish the setup.
...
**1.19**Next drag and drop selected Item on the same swimlane.Your overall setup should look like this.This completes our one - **if else** logic
...
**1.2** Click on the request tab as shown below  
...
**1.4**A new page comes up.Click on **Authorization Tab**  followed by end point url as shown below .

![](images/300/img148.png)

**1.5** Next we need to set the request parameter.Click on **Body** section and update the request json as shown below 

![](images/300/img149.png)
