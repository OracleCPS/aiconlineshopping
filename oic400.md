...
This is the forth of several labs that are part of the **Oracle Integration Cloud Development** workshop.
...
### **Pre-Requisites**
- **REQUIRED:** 
    - This lab assumes that you have already completed [Lab 300B](/ics300b.md)
...
- Name **Label Hint** as *Order ID* and selecting the checkbox for **Required** checkbox. 
...
**400.4.9a:** Drag and drop a **Currency** _Field_ component below the number component. Again, note the drop position
...
**400.4.10:** Drag and drop a **Select One** component below the currency component, set **Label Hint** to `Ship To` and check the **Required** checkbox
...
- Click on **Design** to come back to your building envirinment.
