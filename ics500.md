...
**5.1.4.4** Congradulation, you deployed the application. 

<!-- Now we are goiing to test it. For that we need to access a WSDL url. Click on the  **Management** tab for the same.
