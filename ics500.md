...
**5.1.2.9** For this implementation its simple workflow,user needs to either approve or reject based on input parameters.Edit/Delete the remaining items and finally it should look like as shown below
